...
*✦ recent agent benchmarks (2026-06-24 discovery):*
...
*✦ New section (2026-06-24): 47 spoken-media sources transcribed and deep-noted (verbatim quotes + timestamps). Catalog: `desearch/index/talks-podcasts.md`.*

### 🎤 Conference & individual talks
- **How to Construct Domain Specific LLM Evaluation Systems** — Hamel Husain & Emil Sedgh — `https://www.youtube.com/watch?v=eLXF0VojuSs` · *talk* (AI Engineer World's Fair 2024)
- **How to look at your data** — Jeff Huber & Jason Liu — `https://www.youtube.com/watch?v=jryZvCuA0Uc` · *talk* (AI Engineer World's Fair 2025)
- **Failure is a Funnel** — Bryan Bischof — `https://www.youtube.com/watch?v=k98gDjYbSaU` · *talk* (Data Council 2025)
- **Using LLMs as Judges: Insights, Challenges, Best Practices** — Eugene Yan — `https://www.youtube.com/watch?v=7EGF0Mc0_os` · *talk* (Jason Liu series 2024)
- **Scaling Up Vibe Checks for LLMs** — Shreya Shankar — `https://www.youtube.com/watch?v=eGVDKegRdgM` · *talk* (Stanford MLSys #97)
- **Why LLM Data Processing Pipelines Fail** — Shreya Shankar — `https://www.youtube.com/watch?v=H-1QaLPnGsg` · *talk* (LangChain Interrupt 2025)
- **Evals Are Not Unit Tests** — Ido Pesok (Vercel v0) — `https://www.youtube.com/watch?v=L8OoYeDI_ls` · *talk* (AI Engineer 2025)
- **Building Metrics that actually work (workshop)** — David Karam (Pi Labs) — `https://www.youtube.com/watch?v=jxrGodnopHo` · *talk* (AI Engineer 2025)
- **From Self-driving to Autonomous Voice Agents** — Brooke Hopkins (Coval) — `https://www.youtube.com/watch?v=kDczF4wBh8s` · *talk* (AI Engineer 2025)
- **Fuzzing in the GenAI Era** — Leonard Tang (Haize Labs) — `https://www.youtube.com/watch?v=OMGPvW8TBHc` · *talk* (AI Engineer 2025)
- **On Engineering AI Systems that Endure the Bitter Lesson** — Omar Khattab (DSPy) — `https://www.youtube.com/watch?v=qdmxApz3EJI` · *talk* (AI Engineer 2025)
- **Strategies for LLM Evals (harnesses workshop)** — Taylor Jordan Smith — `https://www.youtube.com/watch?v=89NuzmKokIk` · *talk* (AI Engineer 2025)
- **The Future of Evals** — Ankur Goyal (Braintrust) — `https://www.youtube.com/watch?v=MC55hdWLq4o` · *talk* (AI Engineer 2025)
- **3 Key Ideas in AI in 2025 (Verifier's Law)** — Jason Wei (OpenAI) — `https://www.youtube.com/watch?v=b6Doq2fz81U` · *talk* (Stanford AI Club 2025)
- **Some Intuitions About Large Language Models** — Jason Wei — `https://www.youtube.com/watch?v=l898fqkjdFc` · *talk* (The AI Conference 2025)
- **Deep Dive into LLMs like ChatGPT** — Andrej Karpathy — `https://www.youtube.com/watch?v=7xTGNNLPyMI` · *talk* (2025)
- **RLHF: Progress and Challenges** — John Schulman — `https://www.youtube.com/watch?v=hhiLw5Q_UFg` · *talk* (UC Berkeley EECS 2023)
- **Aligning Open Language Models** — Nathan Lambert (Ai2) — `https://www.youtube.com/watch?v=AdLgPmcrXwQ` · *talk* (Stanford CS25 V4)
- **Building LLM Applications for Production** — Chip Huyen — `https://www.youtube.com/watch?v=spamOhG7BOA` · *talk* (MLOps LLMs in Prod 2023)
- **The Model is the Product** — Han-Chung Lee — `https://www.youtube.com/watch?v=4dUFIRj-BWo` · *talk* (Data Council 2025)
- **RL Environments at Scale** — Will Brown (Prime Intellect) — `https://www.youtube.com/watch?v=_IzZWeuTx7I` · *talk* (AI Engineer 2025)
- **LLM benchmarks in the time of agents** — Florian Brand (Prime Intellect) — `https://www.youtube.com/watch?v=kmTMc-fVSXw` · *talk* (Big Techday 26 (2026))

### 🎙 Podcast episodes
- **Evals, error analysis, and better prompts** — Hamel Husain (How I AI / Claire Vo) — `https://www.youtube.com/watch?v=PgzOBNse2EA` · *podcast* (How I AI)
- **Evals are the new PRD for AI products** — Ankur Goyal (How I AI) — `https://www.youtube.com/watch?v=QE_1hRLsehM` · *podcast* (How I AI)
- **Ep 60: 10 Things I Hate About AI Evals** — Hamel Husain (Vanishing Gradients) — `https://www.youtube.com/watch?v=QEk-XwrkqhI` · *podcast* (Vanishing Gradients)
- **Ep 50: A Field Guide to Rapidly Improving AI Products** — Hamel Husain (Vanishing Gradients) — `https://www.youtube.com/watch?v=rWToRi2_SeY` · *podcast* (Vanishing Gradients)
- **Five Hard-Earned Lessons About Evals** — Ankur Goyal (Latent Space) — `https://www.youtube.com/watch?v=a4BV0gGmXgA` · *podcast* (Latent Space)
- **Artificial Analysis: Independent LLM Evals** — Cameron & Hill-Smith (Latent Space) — `https://www.youtube.com/watch?v=v5mBjeX4TJ8` · *podcast* (Latent Space)
- **Reality: The Final Eval (Vending-Bench)** — Petersson & Backlund (Andon Labs) — `https://www.youtube.com/watch?v=ZAimcoJXUBo` · *podcast* (Latent Space / Cognitive Revolution)
- **#5 Designing Evals** — Vaibhav Gupta & Dex (AI That Works) — `https://www.youtube.com/watch?v=-N6MajRfqYw` · *podcast* (AI That Works)
- **#16 Evaluating Prompts Across Models** — AI That Works — `https://www.youtube.com/watch?v=OawyQOrlubM` · *podcast* (AI That Works)
- **#24 Evals for Classification** — AI That Works — `https://www.youtube.com/watch?v=5Fy0hBzyduU` · *podcast* (AI That Works)
- **#34 Multimodal Evals** — AI That Works — `https://www.youtube.com/watch?v=jzhVo0iAX_I` · *podcast* (AI That Works)
- **#372 It's 2026 and We're Still Talking Evals** — Maggie Konstanty (MLOps Community) — `https://www.youtube.com/watch?v=9EjWR3QpJYk` · *podcast* (MLOps Community)
- **#728 Generative Benchmarking** — Kelly Hong (TWIML) — `https://www.youtube.com/watch?v=3kbiGPn0cOo` · *podcast* (TWIML AI)
- **Shaping AI Benchmarks (HELM)** — Percy Liang (Gradient Dissent) — `https://www.youtube.com/watch?v=kwkdKirqi6s` · *podcast* (Gradient Dissent)
- **Evaluating LLMs with Chatbot Arena** — Joseph Gonzalez (Gradient Dissent) — `https://www.youtube.com/watch?v=okHMaczHPXc` · *podcast* (Gradient Dissent)
- **Evaluating AI, Designing for Non-Determinism** — Aman Khan (Learning from ML) — `https://www.youtube.com/watch?v=v0eTTn7ZPEc` · *podcast* (Learning from Machine Learning)
- **Karpathy: RL is terrible, why benchmarks mislead** — Andrej Karpathy (Dwarkesh) — `https://www.youtube.com/watch?v=-lRBpyPt79c` · *podcast* (Dwarkesh Podcast)
- **How to Build AI Evals in 2026 (Step-by-Step)** — Hamel Husain & Shreya Shankar — `https://www.youtube.com/watch?v=J7N9FMouSKg` · *podcast* (Aakash Gupta 2026)

### 🎓 University lectures
- **Towards Building Safe & Trustworthy AI Agents** — Dawn Song — `https://www.youtube.com/watch?v=QAgR4uQ15rc` · *lecture* (Berkeley LLM Agents MOOC F24)
- **Towards Building Safe and Secure Agentic AI** — Dawn Song — `https://www.youtube.com/watch?v=ti6yPE2VPZc` · *lecture* (Berkeley Advanced LLM Agents Sp25)
- **Measuring Agent Capabilities and Anthropic's RSP** — Ben Mann (Anthropic) — `https://www.youtube.com/watch?v=6y2AnWol7oo` · *lecture* (Berkeley LLM Agents MOOC F24)
- **Open-Source and Science in the Era of Foundation Models** — Percy Liang — `https://www.youtube.com/watch?v=f3KKx9LWntQ` · *lecture* (Berkeley LLM Agents MOOC F24)
- **CS336 Lecture 12: Evaluation** — Hashimoto & Liang — `https://www.youtube.com/watch?v=x-R5l2HsXqM` · *lecture* (Stanford CS336 2025)
